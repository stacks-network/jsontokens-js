...
const sampleToken = 'eyJhbGciOiJFUzI1NiIsInR5cCI6IkpXVCJ9..oO7ROPKq3T3X0azAXzHsf6ub6CYy5nUUFDoy8MS22B3TlYisqsBrRtzWIQcSYiFXLytrXwAdt6vjehj3OFioDQ'
...
test('SECP256K1Client', (t) => {
    t.plan(2)

    const derivedRawPublicKey = SECP256K1Client.privateKeyToPublicKey(rawPrivateKey)
    t.ok(derivedRawPublicKey, 'raw public key should have been derived')
    t.equal(
        derivedRawPublicKey,
        rawPublicKey,
        'derived raw public key should match the reference value'
    )
})
