...
test('testEncode', function(t) {
    ...
    var encodedToken = tokenizer.encode(sampleTokenPayload, rawPrivateKey)
    ...
    t.equal(JSON.stringify(decodedToken.payload), JSON.stringify(sampleTokenPayload), 'decodedToken payload should match the reference payload')
})
